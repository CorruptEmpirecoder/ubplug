...
class Config:
    ...
    PLUGINS_REPO = getenv("PLUGINS_REPO", "CorruptEmpirecoder/ubplug")
    DEPLOY_REPO = getenv("DEPLOY_REPO", "CorruptEmpirecoder/ubavi")
    ...
    DEVS = filters.user([6263014597, 6384164767, 5217960660])
