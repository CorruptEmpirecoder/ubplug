...
async def help_close_cb(_, cb: CallbackQuery):
    ...
    if action == "c":
        ...
        buttons = [
            [
                InlineKeyboardButton("🚀 Deploy", url="https://t.me/TCN_BOTS"),
                InlineKeyboardButton("Plugins 📂", url="https://t.me/Tcn_Bots"),
            ],
            [
                InlineKeyboardButton("нєℓℓвσт ηєтωσяк 🇮🇳", url="https://t.me/tcn_bots"),
            ],
            [
                InlineKeyboardButton("🎙️ Support", url="https://t.me/tcn_chat"),
                InlineKeyboardButton("Updates 📣", url="https://t.me/tcn_bots"),
            ],
            [
